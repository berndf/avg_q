/*
 * Copyright (C) 1996-1999,2001-2004,2006-2010 Bernd Feige
 * 
...
read_generic_init(transform_info_ptr tinfo) {
 ...
 if (datatype_size[local_arg->datatype]==0) {
  ...
  if (statbuff.st_size==0) {
   ...
   local_arg->NumSamples = (statbuff.st_size-local_arg->fileoffset+local_arg->block_gap)/local_arg->bytes_per_point;
  }
 }
