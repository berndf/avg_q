 ...
 */
void 
getdev(long int n, Device *devs, short int *vals)
{
	int	i;
 ...
 */
void
mapcolor(Colorindex i, short int r, short int g, short int b)
{
	Token	*tok;
