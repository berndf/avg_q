 ...
 */
void
arc(Coord x, Coord y, Coord radius, Angle sang, Angle eang)
{
	Token	*t;
	float	cx, cy, dx, dy;
 ...
 */
void
arcs(Scoord x, Scoord y, Scoord radius, Angle sang, Angle eang)
{
 ...
 */
void
arci(Icoord x, Icoord y, Icoord radius, Angle sang, Angle eang)
{
	arc((Coord)x, (Coord)y, (Coord)radius, sang, eang);
}
 ...
 */
void
arcf(Coord x, Coord y, Coord radius, Angle sang, Angle eang)
{
	Token	*t;
	float	cx, cy, dx, dy;
 ...
 */
void
arcfs(Scoord x, Scoord y, Scoord radius, Angle sang, Angle eang)
{
 ...
 */
void
arcfi(Icoord x, Icoord y, Icoord radius, Angle sang, Angle eang)
{
	arcf((Coord)x, (Coord)y, (Coord)radius, sang, eang);
}
