 ...
 */
void
perspective(Angle ifov, float aspect, Coord hither, Coord yon)
{
	Matrix		mat;
	float		fov;
 ...
 */
void
window(Coord left, Coord right, Coord bottom, Coord top, Coord hither, Coord yon)
{
	Matrix		mat;
 ...
 */
void
ortho(Coord left, Coord right, Coord bottom, Coord top, Coord hither, Coord yon)
{
	Matrix		mat;
